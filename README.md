...
### Easy Way
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/JUNIDEV0207/junidev)
### Hard Way
...
### Required Variables
* `BOT_TOKEN`: Bot Yarating [@BotFather](https://telegram.dog/BotFather), and get the Telegram API token.
